import {
  ...
  export class CoinbaseTradeAgent {
      ...
      private walletProvider: CdpWalletProvider | undefined;
      ...
      async initialize() {
          try {
              ...
              console.log("Agent initialized and connected to network");
              return this;
          } catch (error) {
      ...
      /**
       * Clean up resources and save wallet data
       */
      async cleanup() {
          try {
              if (this.walletProvider) {
                  ...
                  console.log("Saved wallet data during cleanup");
              }
          } catch (error) {
