...
const agent = new Agent({
    ...
    description:
        "You are crypto advisor, you give sound cryptocurrency advice, keep your answers short and concise.",
    instructions: ["check on the latest crypto news, and give a digest of the news"],
    tools: {
        cryptoNewsTool,
    },
});
...
const zee = new ZeeWorkflow({
    description:
        "You are crypto advisor, you give sound cryptocurrency advice, keep your answers short and concise.",
    output: "Advice on how to invest in crypto",
    agents: {
        agent,
    },
});
